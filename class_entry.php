...
function setActive()
{
	...
	if(document.getElementById('floor_no').value=='' || isNaN(document.getElementById('floor_no').value))// || document.getElementById('error_received').value==1)
	{
  ...
  <form name="f1" method="POST">
    ...
    <tr><td><p class="header1">&nbsp;</p>
               <p class="header1">Create new floor</p></td></tr>
                  <tr>
                      <td ><table cellpadding="0"  cellspacing="0"><tr><td><p class="header0">Floor no</p></td><td ><p id="NaN" class="NaN"></p></td></tr></table></td>
