...
<script>
var toggle=false;
function validate_floor_edit(e)
{
	//alert('ok');
	if(document.getElementById('floor_no_e').value=='')
	{
		var r=0;
	}
	else
	{
		var r=parseInt(document.getElementById('floor_no_e').value);
	}
	
	
	
		if(isNaN(document.getElementById('floor_no_e').value) || document.getElementById('floor_no_e').value=='')
	{
			document.getElementsByClassName('e_d')[0].style.height="20px";
				
				document.getElementsByClassName('e_d')[0].style.padding="10px";
				document.getElementById('e_d').innerHTML="Invalid floor number.";
...
var al=document.getElementById('alias_e').value;
	
	
	//alert(room);
	var floor_no=document.getElementById('floor_no_e').value;
	var str="floor_valid_e.php?floor_no="+floor_no+"&alias="+al+"&id="+e;
	...
	xmlHttp.onreadystatechange=function()
	{
		if(xmlHttp.readyState==4 || xmlHttp.readyState=='complete')
		{
			...
			else
			{
					...
					var regEx=/[!@#$%^&*()_+<>,.":{}|]/;
					if(document.getElementById('alias_e').value=='' || document.getElementById('alias_e').value.match(regEx)!=null)
	{
		
	document.getElementsByClassName('e_d')[0].style.height="20px";
				
				document.getElementsByClassName('e_d')[0].style.padding="10px";
				document.getElementById('e_d').innerHTML="Invalid floor alias.";
				document.getElementById('submit_e').disabled=true;
	}
	else{
...
function e_d()
{
 ...
 function submit_new_floor()
 {
	...
	var status_a=document.getElementById('status');
		...
		var alias=document.getElementById('floor_alias').value;
		
		
		var url="floor_ex.php?submit=1&floor_no="+floor_no+"&alias="+alias+"&status="+status;
		//alert(url);
		var xmlHttp= new XMLHttpRequest();
		xmlHttp.onreadystatechange=function()
		{
			if(xmlHttp.readyState==4 || xmlHttp.readyState=='complete')
			{
				...
				document.getElementById('submit_floor').disabled=true;
				//update_content();
			}
 ...
 function show_context()
{
 ...
 
 {
	...
	var status_a=document.getElementById('status_e');
		...
		var alias=document.getElementById('alias_e').value;
		
	var floor_id=document.getElementById('floor_id_e').value;
		var str='';
	if(document.getElementById('filter_state').value==1)
	{
		var f=document.getElementById('floor_h').value;
		...
		var url="floor_ex.php?save=1&floor_id="+floor_id+"&floor_no="+floor_no+"&status="+status+"&alias="+alias+str;
	//	alert(url);
		var xmlHttp= new XMLHttpRequest();
		xmlHttp.onreadystatechange=function()
		{
...
var str='';
	...
	var url="floor_ex.php?update=1"+str;
	var xmlHttp=new XMLHttpRequest();
	xmlHttp.onreadystatechange=function()
	{
		if(xmlHttp.readyState==4 || xmlHttp.readyState=='complete')
...
function delete_floor(e)
{
	...
	var url="floor_ex.php?delete="+e+str;
	var xmlHttp=new XMLHttpRequest();
	xmlHttp.onreadystatechange=function()
	{
		if(xmlHttp.readyState==4 || xmlHttp.readyState=='complete')
...
var url="floor_ex.php?edit_r="+e+str;
//alert(url);
//alert(url);
	var xmlHttp=new XMLHttpRequest();
	xmlHttp.onreadystatechange=function()
...
function poll_check()
{
	...
	*/
	...
	var room_id;
	var str="floor_ex.php";
	for(i=0;i<cb.length;i++)
	{
		if(cb[i].checked)
		{
			floor_id="text"+cb[i].id;
			arg_name[number_of_args]="floor_"+number_of_args;
			arg_value[number_of_args]=document.getElementById(floor_id).value;
...
function delete_m()
{
	...
	{
		delete_floor(document.getElementById('delete_info').value);
	}
	close_modal();
}
...
{
	var f=parseInt(document.getElementById('floor_no').value);
	var regEx=/[!@#$%^&*()_+<>,.?;':"{}|]/;
	if(document.getElementById('floor_alias').value.match(regEx)!=null)
	{
			document.getElementById('floor_alias_valid').style.height="20px";
			document.getElementById('floor_alias').style.borderColor="red";
			document.getElementById('floor_alias_valid').innerHTML="Invaid floor alias";
	}
	else
	{
		
		document.getElementById('floor_alias_valid').style.height="0px";
			document.getElementById('floor_alias').style.borderColor="#ccc";
			document.getElementById('floor_alias_valid').innerHTML="";
		...
		for(i=0;i<9;i++)
		{
			...
			{
				if(document.getElementById('floor_alias').value.indexOf(i.toString())!=-1)
				{
					document.getElementById('floor_alias_valid').style.height="20px";
			document.getElementById('floor_alias').style.borderColor="#F96146";
			document.getElementById('floor_alias_valid').innerHTML="The floor alias seems to be incorrrect";
...
function validate_NaN()
{
	...
	{
		document.getElementById('floor_no_valid').innerHTML="Invalid floor number";
		document.getElementById('floor_no_valid').style.height="20px";
	...
	else
	{
		...
		document.getElementById('floor_no_valid').innerHTML="";
		document.getElementById('floor_no_valid').style.height="0px";
...
{
	if(document.getElementById('floor_no').value=='' || isNaN(document.getElementById('floor_no').value))
	{
		var r=0;
	document.getElementById('floor_alias').value="";
	}
	...
	{
		var r=parseInt(document.getElementById('floor_no').value);
		...
		document.getElementById('floor_alias').value=r+suffix+" floor";
	}
...
function setActive()
{
	...
	var regEx=/[!@#$%^&*()_+~`<>,.:";'{}?]/;
	if(document.getElementById('floor_no').value=='' || isNaN(document.getElementById('floor_no').value)|| document.getElementById('floor_alias').value=='' ||document.getElementById('floor_alias').value.match(regEx)!=null) // || document.getElementById('error_received').value==1)
	{
		document.getElementById('submit_floor').disabled=true;
		//alert('ok');
	}
	...
	{
		document.getElementById('submit_floor').disabled=false;
	}
}
...
<td width="66" align="center"  class="lnk"  bgcolor="#0078d7"><a href="floor_entry.php" class="a">Floors</a></td>
 ...
 <div class="fx" id="fx">
  <form name="f1" method="POST">
    ...
    <tr><td><p class="header1">&nbsp;</p>
               <p class="header1">Create new floor</p></td></tr>
                  <tr>
                      <td ><table cellpadding="5"  cellspacing="5"><tr><td><p class="header0">Floor no</p></td>
                      </tr></table></td>
                      </tr><tr> <td height="20"  align="center"> <input type="text" name="floor_no" size="10" REQUIRED  class="txt0" id="floor_no" onKeyUp="validate_NaN()"></td>
                      
                      <tr><td>
                       <div class="valid" id="floor_no_valid"></div>
						</td>
                       </tr></tr>
                     <tr>
                      ...
                      <tr> <td align="center"><select name="status"   class="txt" id="status" REQUIRED>
                        ...
                        <tr>
                          <td width="195">
              <p class="header0">  Floor Alias</p>
                </td>
                </tr>
                <tr>
                <td align="center">
                <input type="text" name="floor_no" size="10" REQUIRED  class="txt0" id="floor_alias" onKeyUp="validate_alias()">
                
                </td></tr>
                <tr><td>
                       <div class="valid" id="floor_alias_valid"></div>
						</td>
                       </tr>
                <tr>
                ...
                <td height="84" align="center" ><input type="button" value="submit" class="button" onClick="submit_new_floor()" id="submit_floor" disabled></td>
                    </tr>      
        </table>
     </form>
