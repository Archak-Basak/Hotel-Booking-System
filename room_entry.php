...
function e_d()
{
 ...
 function submit_new_room()
 {
	...
	if(document.getElementById('error_received').value==0)
		...
		var floor_a=document.getElementById('floor_no');
		var floor_no=floor_a.options[floor_a.selectedIndex].value;	
		
	var status_a=document.getElementById('status');
		var status=status_a.options[status_a.selectedIndex].value;
		
		var type_a=document.getElementById('type');
		var type=type_a.options[type_a.selectedIndex].value;
		
		var rate=document.getElementById('rate').value;
		//var upgradable=up_a.options[up_a.selectedIndex].value;
		
		var url="room_ex.php?submit=1&room="+room_no+"&floor="+floor_no+"&status="+status+"&type="+type+"&rate="+rate;
		var xmlHttp= new XMLHttpRequest();
		xmlHttp.onreadystatechange=function()
		{
			if(xmlHttp.readyState==4 || xmlHttp.readyState=='complete')
 ...
 function undo_d()
	...
	{
		var r=document.getElementById('room_h').value;
		var f=document.getElementById('floor_h').value;
		var s=document.getElementById('status_h').value
		var t=document.getElementById('type_h').value;
		var rt=document.getElementById('rate_h').value;
		str="&filter_mode=1&room_f="+r+"&floor_f="+f+"&status_f="+s+"&type_f="+t+"&rate_f="+rt;
		//alert(url);
		...
		xmlHttp.open("GET",'room_ex.php?undo=1'+str,true);
		xmlHttp.send();
		}
 ...
 function show_context()
{
 ...
 
 {
	 ...
	 hide_menu(1);
	  document.getElementById('room_no').value='';
		var room_no=document.getElementById('room_no_e').value;
		var room_id=document.getElementById('room_id_e').value;
		var floor_a=document.getElementById('floor_e');
		var floor_no=floor_a.options[floor_a.selectedIndex].value;	
		
		var status_a=document.getElementById('status_e');
		var status=status_a.options[status_a.selectedIndex].value;
		
		var type_a=document.getElementById('type_e');
		var type=type_a.options[type_a.selectedIndex].value;
		
		//var rate_a=document.getElementById('rate_e').value;
		//var upgradable=up_a.options[up_a.selectedIndex].value;
	...
	if(document.getElementById('filter_state').value==1)
	{
		...
		var url="room_ex.php?save=1&room_id="+room_id+"&room_no="+room_no+"&floor_no="+floor_no+"&status="+status+"&type="+type+str;
	//	alert(url);
		var xmlHttp= new XMLHttpRequest();
		xmlHttp.onreadystatechange=function()
		{
...
var str='';
	...
	var url="room_ex.php?update=1"+str;
	var xmlHttp=new XMLHttpRequest();
	xmlHttp.onreadystatechange=function()
	{
		if(xmlHttp.readyState==4 || xmlHttp.readyState=='complete')
...
function delete_room(e)
{
	...
	var url="room_ex.php?delete="+e+str;
	var xmlHttp=new XMLHttpRequest();
	xmlHttp.onreadystatechange=function()
	{
		if(xmlHttp.readyState==4 || xmlHttp.readyState=='complete')
...
var url="room_ex.php?edit_r="+e+str;
//alert(url);
//alert(url);
	var xmlHttp=new XMLHttpRequest();
	xmlHttp.onreadystatechange=function()
...
function poll_check()
{
	...
	*/
	...
	for(i=0;i<cb.length;i++)
	{
		if(cb[i].checked)
		{
			room_id="text"+cb[i].id;
			arg_name[number_of_args]="room_"+number_of_args;
			arg_value[number_of_args]=document.getElementById(room_id).value;
	...
	if(document.getElementById('filter_state').value==1)
	{
		...
		var t=document.getElementById('type_h').value;
		var rt=document.getElementById('rate_h').value;
		str2="&filter_mode=1&room_f="+r+"&floor_f="+f+"&status_f="+s+"&type_f="+t+"&rate_f="+rt;
...
function filter_result()
{
		...
		hide_menu(1);
		 document.getElementById('room_no').value='';
		set_filter();
		var room_a=document.getElementById('filter_room');
		var room_no=room_a.options[room_a.selectedIndex].value;	
		document.getElementById('room_h').value=room_no;
		...
		var type_a=document.getElementById('filter_type');
		var type=type_a.options[type_a.selectedIndex].value;
		document.getElementById('type_h').value=type;
		var rate_a=document.getElementById('filter_rate');
		var rate=rate_a.options[rate_a.selectedIndex].value;
		//var upgradable=up_a.options[up_a.selectedIndex].value;
		document.getElementById('rate_h').value=rate;
		var url="room_ex.php?filter_mode=1&room_f="+room_no+"&floor_f="+floor_no+"&status_f="+status+"&type_f="+type+"&rate_f="+rate;
...
function delete_m()
{
	...
	{
		delete_room(document.getElementById('delete_info').value);
	}
	close_modal();
}
...
{
	if(isNaN(document.getElementById('room_no').value))
	{
		document.getElementById('room_no_valid').style.height="20px";
		document.getElementById('room_no_valid').innerHTML="Invalid room number";
		document.getElementById('room_no').style.borderColor="#f44336";
	...
	{
		document.getElementById('room_no_valid').style.height="0px";
		document.getElementById('room_no_valid').innerHTML="";
	
		document.getElementById('room_no').style.borderColor="#ccc";
...
{
	if(document.getElementById('room_no').value=='' || isNaN(document.getElementById('room_no').value))
		var r=0;
	
	
	else
		var r=parseInt(document.getElementById('room_no').value);
	var f=document.getElementById('floor_no');
	var fl=parseInt(f.options[f.selectedIndex].value);
	var room=fl*100+r;
	
	//alert(room);
	
	var str="room_valid.php?room="+room;
	var xmlHttp=new XMLHttpRequest();
	xmlHttp.onreadystatechange=function()
	{
		if(xmlHttp.readyState==4 || xmlHttp.readyState=='complete')
...
function validate_rate()
{
	...
	{
		document.getElementById('rate_alert').innerHTML="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-invalid amount";
		document.getElementById('rate').style.borderColor="#f44336";
	//	document.getElementById('submit_room').disabled=true;
	...
	{
		document.getElementById('rate_alert').innerHTML="";
		document.getElementById('rate').style.borderColor="#ccc";		
...
function setActive()
{
	if(document.getElementById('rate').value=='' || document.getElementById('room_no').value=='' || isNaN(document.getElementById('rate').value) || isNaN(document.getElementById('room_no').value) || document.getElementById('error_received').value==1)
	{
		document.getElementById('submit_room').disabled=true;
		//alert('ok');
	}
...
<td width="77" align="center" class="lnk"  bgcolor="#0078d7"><a href="room_entry.php" class="a">Rooms</a></td>
 ...
 <div class="fx" id="fx">
  <form name="f1" method="POST">
    ...
    <tr><td><p class="header1">&nbsp;</p>
               <p class="header1">Create new room</p></td></tr>
                  <tr>
                      <td ><table cellpadding="0"  cellspacing="0"><tr><td><p class="header0">Room no</p></td><td ><p id="NaN" class="NaN"></p></td></tr></table></td>
                      </tr><tr> <td height="20"  align="center"> <input type="text" name="room_no" size="10" REQUIRED  class="txt0" id="room_no" onKeyUp="validate_NaN()"></td></tr>
                     <tr><td>
                       <div class="valid" id="room_no_valid"></div>
						</td>
                       </tr>
                      <tr>
                      <td ><p class="header0">Floor No</p></td>
                      
                      </tr><tr><td height="30" align="center"><select name="floor_no" default="1"  id="floor_no"  class="txt" REQUIRED onChange="validate_room()">                  
                       <?php
                      ...
                      <td ><p class="header0">Status</p></td></tr>
                      <tr> <td align="center"><select name="status"   class="txt" id="status" REQUIRED>
                        ...
                        <tr>
                          <td width="195">
              <p class="header0">  Type</p>
                </td>
                </tr><tr>
                <td align="center">
                <select name="type"   class="txt" id="type" REQUIRED>
                ...
                <tr>
                 <td ><table><tr><td>
               <p class="header0"></p></td><td> <p id="rate_alert" class="NaN"></p></td></tr></table>
                </td></tr><tr>  <td align="center">
                <input type="text" name="rate" id="rate" REQUIRED class="txt0" onKeyUp="validate_rate()" style="visibility:hidden" value="2">
                ...
                <td height="84" align="center" ><input type="button" value="submit" class="button" onClick="submit_new_room()" id="submit_room" disabled></td>
                    </tr>      
        </table>
     </form>
   ...
   <!-- <input type="button" onClick="expand()" class="button" value="Add New" id="add">-->
     ...
     <input type="hidden" id="room_h">
     <input type="hidden" id="floor_h">
     <input type="hidden" id="type_h">
     <input type="hidden" id="status_h">
     <input type="hidden" id="rate_h">
